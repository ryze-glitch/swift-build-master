    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">Accesso riservato al personale autorizzato</p>
        </div>
        ...
        <Card className="glass-strong p-6">
          <div className="space-y-4">
            <div className="text-center mb-6">
              ...
              <p className="text-sm text-muted-foreground">Solo per personale autorizzato U.O.P.I.</p>
            </div>
            ...
            <div className="text-xs text-center text-muted-foreground mt-4">
              <p>Solo utenti autorizzati possono accedere.</p>
              <p className="mt-1">Contatta la dirigenza per richiedere l'accesso.</p>
            </div>
          </div>
        </Card>
